...
const NavBar = () => {
  ...
  return (
    <div class = "flex ... justify-around ... bg-gradient-to-r from-cyan-300 to-purple-300">
        <div>
            <img class="object-scale-down h-30 w-40 ..." src="https://i.imgur.com/83G3pe2.png" />
        </div>
        <div class = "mt-2">
            ...
            <a href='/edit' class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ">Edit</a>
